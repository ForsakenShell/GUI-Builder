/*
 * PersistentLocation.cs
 *
 * Object Reference Persistent Location field.
 *
 */
...
namespace Engine.Plugin.Forms.Fields.ObjectReference
{
    ...
    public class PersistentLocation : CachedUIntField
    {
        
        public PersistentLocation( Form form ) : base( form, "XLCN" ) {}
