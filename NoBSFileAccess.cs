...
namespace Border_Builder
{
    ...
    unsafe public static class NoBSFileAccess
    {
        ...
        private static extern bool ReadFile( Microsoft.Win32.SafeHandles.SafeFileHandle handle, void* buffer, uint numBytesToRead, out uint numBytesRead, IntPtr overlapped );
        
        [DllImport("kernel32.dll")]
        private static extern bool SetFilePointerEx( Microsoft.Win32.SafeHandles.SafeFileHandle hFile, long liDistanceToMove, out long lpNewFilePointer, uint dwMoveMethod );
